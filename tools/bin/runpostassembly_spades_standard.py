...
for sample in samples:
   os.system("python filter_assembly_dire_spades_standard.py -s " + sample)
   os.system("python quast_dire_spades_standard.py -s " + sample)
   os.system("python uploadquast_spades_standard.py -s " + sample)
   os.system("python amrfinder_dire_spades_standard.py -s " + sample)
