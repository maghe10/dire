...
os.system("mkdir -p /root/sequencing/intermediate/checkm_unicycler_normal/")
os.system("checkm lineage_wf -r -t 1 -x fasta /root/sequencing/dire/unicycler_normal/assembly /root/sequencing/intermediate/checkm_unicycler_normal/")
os.system("checkm qa /root/sequencing/intermediate/checkm_unicycler_normal/lineage.ms /root/sequencing/intermediate/checkm_unicycler_normal/ --tab_table -f /root/sequencing/intermediate/checkm_unicycler_normal/qa.tsv")
