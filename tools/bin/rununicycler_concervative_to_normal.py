...
for sample in samples:
   os.system("python downloadunicycler_conservative.py -s " + sample)
   os.system("python unicycler_dire_conservative_to_normal.py -s " + sample)
   os.system("python uploadunicycler_conservative_to_normal.py -s " + sample)
