...
for sample in samples:
   os.system("python filter_assembly_dire_optimal.py -s " + sample)
   os.system("python quast_dire_optimal.py -s " + sample)
   os.system("python uploadquast_optimal.py -s " + sample)
   os.system("python amrfinder_dire_optimal.py -s " + sample)
