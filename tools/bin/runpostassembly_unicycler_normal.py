...
#allSamples = samplesK + samplesL + samplesM + samplesN
...
for sample in samples:
   os.system("python filter_assembly_dire_unicycler_conservative_to_normal.py -s " + sample)
   os.system("python quast_dire_unicycler_normal.py -s " + sample)
   os.system("python uploadquast_unicycler_normal.py -s " + sample)
   os.system("python amrfinder_dire_unicycler_normal.py -s " + sample)
