...
for sample in samples:
	f = "\'C:\\Users\\magnu\\OneDrive - Västra Götalandsregionen\\DIRE\\Illumina\\trimmed\\sample" + sample + "_1_val_1.fq.gz\'"
	b = "\'C:\\Users\\magnu\\OneDrive - Västra Götalandsregionen\\DIRE\\Illumina\\trimmed\\sample" + sample + "_2_val_2.fq.gz\'"
	command = "attrib.exe +U -P " + f
	print(command)
	os.system(command)
	command = "attrib.exe +U -P " + b
	print(command)
	os.system(command)
