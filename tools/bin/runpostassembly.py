...
for sample in samples:
   os.system("python filter_assembly_dire.py -s " + sample)
   os.system("python quast_dire.py -s " + sample)
   os.system("python uploadquast.py -s " + sample)
   os.system("python amrfinder_dire.py -s " + sample)
