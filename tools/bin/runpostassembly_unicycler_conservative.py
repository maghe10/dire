...
for sample in samples:
   os.system("python filter_assembly_dire_unicycler_conservative.py -s " + sample)
   os.system("python quast_dire_unicycler_conservative.py -s " + sample)
   os.system("python uploadquast_unicycler_conservative.py -s " + sample)
   os.system("python amrfinder_dire_unicycler_conservative.py -s " + sample)
