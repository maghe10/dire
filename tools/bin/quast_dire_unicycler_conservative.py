...
contigs = '/root/sequencing/storage/assembly/unicycler_conservative/sample' + sample + ".fasta"
path_to_program = 'quast.py'
output = '/root/sequencing/intermediate/quast/unicycler_conservative/sample' + sample
