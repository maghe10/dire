...
contigs = '/root/sequencing/storage/assembly_unicycler_conservative/sample' + sample + ".fasta"
path_to_program = 'quast.py'
output = '/root/sequencing/intermediate/quast_unicycler_conservative/sample' + sample
