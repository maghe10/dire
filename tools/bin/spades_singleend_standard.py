...
r = '/root/sequencing/storage/trimmed/sample' + sample + "_trimmed.fq.gz"
path_to_program = '/root/sequencing/spades/SPAdes-3.15.4/bin/spades.py'
output = '/root/sequencing/intermediate/spadesstandard/sample' + sample
invoke = 'python' + " " + path_to_program + " -m 10 -t 4 -k 21,33,55,77 --isolate --cov-cutoff auto -s " + r + " -o " + output
print(invoke)
result = "skip" 
